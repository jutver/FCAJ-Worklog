...
Dịch vụ AWS và các dịch vụ Cloud khác gần như hoàn toàn mới với mình trước khi thực tập tại AWS FCJ, nhưng kỳ thực tập đã giúp mình học hỏi rất nhiều về Cloud và nhận ra tầm quan trọng của nó với chuyên ngành. Dự án của mình: Hệ thống Tự động Phản hồi Sự cố và Phân tích Forensics trên AWS phù hợp với lĩnh vực An toàn Thông tin-khác với ngành Công nghệ thông tin
bình thường- nhưng vẫn là trải nghiệm học tập tuyệt vời về bảo mật tổng thể và thực hành với các dịch vụ AWS.
...
### Đề xuất & mong muốn
	...
	- Trả lời: Có, nhóm mình sẵn sàng tiếp tục nếu có cơ hội.
