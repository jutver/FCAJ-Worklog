...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | --------------- | --------------------------------------- |
| 2   | - Reviewed the fundamentals of Monitoring and Logging <br> - Explored the principles of system observability                                                                                           | 03/02/2026 | 03/02/2026      | https://cloudjourney.awsstudygroup.com/ |
| 3   | - Studied Amazon CloudWatch features: <br>  + Performance Metrics <br>  + Log management <br>  + Alarm configurations                                                                                  | 03/03/2026 | 03/03/2026      | https://cloudjourney.awsstudygroup.com/ |
...
* Mastered fundamental AWS monitoring and logging principles, encompassing:
  * Performance Metrics
  * System Logs
  * Request Tracing
* Achieved proficiency in utilizing Amazon CloudWatch:
  * Tracked critical system indicators (e.g., CPU loads, health statuses)
  * Set up automated alerts for irregular system behaviors
* Acquired practical knowledge of AWS CloudTrail:
  * Inspected historical event logs
  * Monitored and audited API interactions
* Grasped the mechanics of distributed tracing via AWS X-Ray:
