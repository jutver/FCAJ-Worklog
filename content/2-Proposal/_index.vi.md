...
![AWS Solution Architecture](/images/2-Proposal/AWS_Solution_Architecture.jpg)
...
| Gỡ băng | AWS Transcribe + Lambda | Chuyển đổi giọng nói thành văn bản; Lambda (`audio2text_lambda`) được kích hoạt khi tạo đối tượng Âm thanh trên S3 |
