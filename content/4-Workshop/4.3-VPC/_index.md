...
{{% notice info %}}
All resources in this section must be created in a single region. For this workshop we will use **ap-southeast-1 (Singapore)**.
{{% /notice %}}
...
You will have to create **two subnets** — one public (for the ALB) and one private (for EC2):
...
![Private Route Table Created](/images/4-Workshop/VPC/B10_Create_Rrivate_RTB.png)
